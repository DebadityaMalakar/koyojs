...
import * as koyo from "../dist/index.mjs";
...
group("pick — top-level keys only (20-key obj, 5 keys)", () => {
  bench("koyojs pick", () => koyo.pick(OBJ, PICK_KEYS));
...
group("exclude — nested path resolution (20-key obj, 5 paths)", () => {
  bench("koyojs exclude", () => koyo.exclude(OBJ, OMIT_KEYS));
